...
people =[]
for i in os.listdir(r'Tutorial/Basic_project/photos/Faces/train'):
    people.append(i)

DIR = r'/Users/charles/Documents/MyProjects/ComputerVision/Tutorial/Basic_project/photos/Faces/train'
